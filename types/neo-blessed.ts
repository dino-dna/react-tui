// copied & editted moderately from blessed
  ...
  export namespace Widgets {
      namespace Types {
          ...
          interface TStyle {
              ...
              focus?: boolean;
              label?: string;
              track?: { bg?: Color; fg?: Color };
              scrollbar?: { bg?: Color; fg?: Color };
          }
      ...
      interface IOptions {
          // @warning - this is the one change from blessed => neo-blessed typings.
          // don't go loosey goosey on us blessed! keep things tight.
          // [name: string]: any;
      }
